...
<?php if ( bbp_current_user_can_access_create_topic_form() ) : ?>
        <div class="Create-thread">
                <div class="plus-div"><a href="javascript:void(0)" id="plus-div">+</a></div>
                    <p>Create a new thread</p>
                    <p>To add your own discussion topic to this thread simply click the icon to the left and fill in the form</p>
                    <div class="clear"></div>
        </div>
