          ...
          <div class="col-md-9 inner-right-side">
            <div class="right-sideTab"> 
              ...
              <ul role="tablist" class="nav nav-tabs">
                <?php if($heading_1!=''){?>
                  <li ><a href="<?php echo get_site_url()?>/events/?events=<?php echo urlencode(get_field('heading_1')) ?>" ><?php the_field('heading_1');?></a></li>
                <?php }if(get_field('heading_2')!=''){ ?>
                <li><a href="<?php echo get_site_url()?>/events/?events=<?php echo urlencode(get_field('heading_2')) ?>" ><?php the_field('heading_2')?></a></li>
                <?php }if(get_field('heading_3')!=''){ ?>
                <li><a href="<?php echo get_site_url()?>/events/?events=<?php echo urlencode(get_field('heading_3')) ?>" ><?php the_field('heading_3')?></a></li>
                <?php } ?>
              </ul>
              <?php } ?>
